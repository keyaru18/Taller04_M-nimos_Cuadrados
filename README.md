...
def ajuste_lineal():
    ...
    # Resultados
    print(f"\nEcuación: y = {theta1[1]:.4f}x + {theta1[0]:.4f}")
...
def ajuste_cuadratico():
    ...
    # Resultados
    print(f"\nEcuación: y = {theta2[2]:.4f}x² + {theta2[1]:.4f}x + {theta2[0]:.4f}")
...
![alt text](11f1f9d3-cb61-4c07-b730-c4b29599dd82.png)

![alt text](20620e84-6787-43f2-a054-b6ad0bf2e067.png)
